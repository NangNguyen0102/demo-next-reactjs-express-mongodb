...
const products = [
  ...
  },
  {
    ...
    images: [
      {
        publicId: "products/airpords_e5cqqr",
  ...
  },
  {
    ...
    images: [
      {
        publicId: "products/camera_ridc0i",
  ...
  },
  {
    ...
    images: [
      {
        publicId: "products/macbook_o2cj2k",
...
//     await Product.insertMany(JSON.stringify(products));
